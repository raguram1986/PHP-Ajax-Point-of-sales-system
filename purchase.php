...
<div class="row">
    ...
    <div class="col-sm-8">
            ...
            <div class="form-group" align="left">
                ...
                <input type="text" class="form-control" placeholder="Due" id="due" name="due" size="30px" disabled>
            </div>
            <div class="form-group" align="left">
            ...
            <div class="card" align="right">
                ...
                <button type="button" id="clear" class="btn btn-warning" onclick="print()">Reset</button>
...
function addProject() {
    ...
    ///var invoice =  vendor:$('#vendor').val(), p_date:$('#p_date').val(), total:$('#total').val(), pay:$('#pay').val(), due:$('#due').val(),payment:$("#payment").val(), data:table_data;
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            window.location.href = "print1.php?last_id=" + last_id;
