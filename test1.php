        ...
        <form class="form-horizontal" id="frmInvoice">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" placeholder="total_cost" size="35px" id="total_cost" name="total_cost">
                    </td>
                    <td>
    ...
    <div class="col-sm-4">
        <div class="col s12 m6 offset-m4">
            ...
            <div class="form-group" align="left">
                ...
                <input type="text" class="form-control" placeholder="Total" id="discounttotal" name="discounttotal" size="30px" required="">
            </div>

            <div class="form-group" align="left">
                <label class="form-label">Grand Total</label>
                <input type="text" class="form-control" placeholder="Grand Total" id="grandtotal" name="grandtotal" size="30px" required="">
            </div>
            </div>
